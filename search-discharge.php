						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">DISCHARGE SUMMARY LIST</li>
								</ul>
							</div>
						</div>
					</div>
											...
											<tbody>
												<?php
                                                    while($run = mysqli_fetch_assoc($sql))
                                                    {
                                                        ...
                                                        <td>'.$run['token_id'].'</td>
                                                        <td><a href="discharge_summary.php?pid='.$run['id'].'&tid='.$run['token_id'].'"><button class="btn btn-primary">View Surgery Form</button></a></td>
                                                        </tr>';
                                                    }
                                                ?>
											</tbody>
