	...
	<body>
		...
		<?php include 'menu.php'; ?>			
			...
			<div class="page-wrapper" id="page-wrapper">
				<div class="text-end">
					<input type="button" value="Print" onclick="window.open('billgb-semi.php?pid=<?php echo $pid;?>&tid=<?php echo $tid;?>&date=<?php echo $dat; ?>','popUpWindow','height=920,width=720,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');">
				</div>
