...
if(isset($_POST['submit']))
{
	...
	'$room_type','$nds','$d_name','$A_name','$tod','$N_staff')";
	  ...
	  echo" <script>document.location='pf1.php?pid=$pid&tid=$tid&name=$name'</script>";
}
	...
	<div class="main-wrapper"> <?php include 'menu.php'; ?> <div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h3 class="page-title">IN PATIENT PREGNANCY SURGERY FORM</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
								<li class="breadcrumb-item"><a href="search-pf.php">Inpatient List</a></li>
