...
<body>
	<div class="main-wrapper"> <?php include 'menu2.php'; ?> <div class="page-wrapper">
									...
									<div class="row">
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "G" </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "L" </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "P" </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "A" </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "R" </div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
