...
<body> <?php include "menu1.php"; ?> <div class="page-wrapper">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="invalid-feedback"> Please choose "Registration date" </div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Patient Name" </div>
											</div>
											<div class="col-lg-9">
												<div class="row">
											...
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Patient Phone Number" </div>
											</div>
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Patient Aadhar Number" </div>
											</div>
											<div class="form-group">
												<label>Patient Qualification</label>
												<input type="text" name="pq" class="form-control" required>
												<div class="invalid-feedback"> Please choose "Patient Qualification" </div>
											</div>
											<div class="form-group">
												<label>Patient Occupation</label>
												<input type="text" name="po" class="form-control" required>
												<div class="invalid-feedback"> Please choose "Patient Occupatin" </div>
											</div>
											<div class="form-group">
												<label>Caste</label>
												<input type="text" name="caste" class="form-control" required>
												<div class="invalid-feedback"> Please choose "Caste" </div>
											</div>
											<div class="form-group">
												<label>Socio-Economic Status</label>
												<input type="text" name="estatus" class="form-control" required>
												<div class="invalid-feedback"> Please choose "SE-status" </div>
											</div>
											<div class="form-group">
												<label>Present Address</label>
												<textarea name="pra" class="form-control" required></textarea>
												<div class="invalid-feedback"> Please choose "Present Address" </div>
											</div>
											<div class="form-group">
												<label>EDD</label>
												<input type="date" name="edd" class="form-control">
												<div class="invalid-feedback"> Please choose "EDD" </div>
											</div>
											<div class="form-group">
												<label>POG</label>
												<input type="date" name="pog" class="form-control">
												<div class="invalid-feedback"> Please choose "POG" </div>
											</div>
										</div>
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Spouse Name" </div>
											</div>
											<div class="col-lg-9">
												<div class="row">
											...
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Spouse Contact" </div>
											</div>
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "Spouse Aadhar Number" </div>
											</div>
											<div class="form-group">
												<label>Spouse Qualification</label>
												<input type="text" name="sq" class="form-control">
												<div class="invalid-feedback"> Please choose "Spouse Occupation" </div>
											</div>
											<div class="form-group">
												<label>Spouse Occupation</label>
												<input type="text" name="so" class="form-control" required>
												<div class="invalid-feedback"> Please choose "Spouse Qualification" </div>
											</div>
											<div class="form-group">
												<label>Religion</label>
												<input type="text" name="religion" class="form-control">
												<div class="invalid-feedback"> Please choose "Religion" </div>
											</div>
											<div class="form-group">
												...
												<div class="invalid-feedback"> Please choose "card type" </div>
											</div>
											<div class="form-group">
												<label>Permanent Address</label>
												<textarea name="pea" class="form-control"></textarea>
												<div class="invalid-feedback"> Please choose "Permanent Address" </div>
											</div>
											<div class="form-group">
												<label>LMP</label>
												<input type="date" name="lmp" class="form-control">
												<div class="invalid-feedback"> Please choose "LMP" </div>
											</div><br>
											<div class="text-end">
