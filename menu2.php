         ...
         <div class="header">
            ...
            <div class="header-left">
                <a href="ou_list.php" class="logo">
                    <img src="assets/img/logo.png" alt="Logo">
                </a>
                <a href="ou_list.php" class="logo logo-small">
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                            <li><a href="d-edd.php"><i class="fas fa-filter fa-lx"></i>EDD</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                 <li><a href="ou_list.php"><i class="fas fa-home fa-lx"></i>HOME</a></li>
                                 <li><a href="udoplist.php"><i class="fas fa-list fa-lx"></i>Update past records</a></li>
