...
$sql = mysqli_query($con,"select distinct(eor.token_id) as token_id, eor.patient_id as id, 
 ppi.name as name, ppi.patient_phone_number as patient_phone_number,pif.type_of_inpatient as toi,eor.time from  patient_billing_details eor, patient_primary_information ppi,patient_inpatient_form pif where eor.patient_id = ppi.id  and eor.token_id=pif.token_id order by eor.time desc");
?>
