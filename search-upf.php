...
where  ppi.id = pi.patient_id and pi.type_of_inpatient='Pregnancy' order by date desc");
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">UPDATE PREGNANCY FORM</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active">UPDATE PREGNANCY FORM</li>
								</ul>
							</div>
						</div>
					</div>
