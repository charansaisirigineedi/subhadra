...
session_start();
include "check.php";
$sql = mysqli_query($con,"select eor.id as id, eor.token_id as token_id, ppi.name as name, ppi.patient_phone_number as patient_phone_number from  existing_op_record eor, patient_primary_information ppi where eor.id = ppi.id order by time desc");
?>
