...
<body>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><b>NAME &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;:</b></h4></span>
			</div>
			<div class="col-md-6">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><b>ADDRESS&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&emsp;&emsp;: </b></h4></span>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><b>DOA&emsp;&emsp;&emsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;:</b></h4>
				</p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><b>DATE OF PROCEDURE&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;: </b></h4>
				</p>
			</div>
			<div class="col-md-8">
				<p style="font-family:Calibri(Body);font-size:25px"><?php
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><b>DOD&emsp;&emsp;&emsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;: </b></h4>
				</p>
			</div>
			<div class="col-md-8">
				<p style="font-family:Calibri(Body);font-size:25px"><?php
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>ADMITTING DIAGNOSIS&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>TREATMENT GIVEN&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>CONDITIONS AT DISCHARGE&emsp;&emsp;&emsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>BREASTS&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>P/A&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>P/V&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>LOCHIA&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>ADVICE ON DISCHARGE&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>DIET&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>ACTIVITY&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;:</B></p>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<p style="font-family:Calibri(Body);font-size:25px"><B>MEDICATIONS AND FOLLOW UP&emsp;&emsp;:</B></p>
			</div>
			<div class="col-md-8">
