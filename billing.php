										...
										<div class="row">
											<div class="col-xl-4 col-lg-6 col-md-6">
												<div class="invoice-info">
													...
													<p class="invoice-details invoice-details-two"> Subhadra Hospitals <br> JP Road,<br> Bhimavaram, AP <br>
													</p>
												</div>
											</div>
											<div class="col-xl-4 col-lg-6 col-md-6">
												<div class="invoice-info">
													...
													<p class="invoice-details invoice-details-two"> <?php echo $res['name']; ?>,<br> <?php echo $res['ppn']; ?>,<br> <?php echo $res['pa']; ?><br>
													</p>
												</div>
											</div>
										</div>
