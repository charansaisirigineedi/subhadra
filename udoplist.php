...
as patient_phone_number from patient_primary_information pif  , pastrecords pr where pr.patient_id = pif.id");
						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Past frecords list</li>
								</ul>
							</div>
						</div>
					</div>
											...
											<tbody>
												<?php
                                                    while($run = mysqli_fetch_assoc($sql))
                                                    {
														...
														<a href="upr.php?pid='.$run['id'].'" class="btn btn-primary">
															Update Past Records
														</a>
													    </div></td>
                                                        </tr>';
